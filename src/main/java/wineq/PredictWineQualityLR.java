...
public class PredictWineQualityLR {
	...
	public static void main(String[] args) {
		...
		if (testFile.exists()) {
			...
			PredictWineQualityLR predictWineQuality = new PredictWineQualityLR();
	...
	public void predict(SparkSession session, String modelPath) {
		...
		System.out.println("Loaded the Logisitc Regression model.");
